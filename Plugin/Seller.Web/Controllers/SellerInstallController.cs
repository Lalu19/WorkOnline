...
namespace Seller.Web.Controllers
{
	...
	public class SellerInstallController : Controller
	{
		...
		private readonly string InstationPath = "Seller.Web";
		public SellerInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
