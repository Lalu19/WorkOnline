...
namespace Warehouse.Management.Controllers
{
    ...
    public class WareHouseInstallController : Controller
    {
        ...
        private readonly string InstationPath = "Warehouse.Management";
        public WareHouseInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
