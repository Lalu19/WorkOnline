...
namespace Report.Web.Controllers
{
    ...
    public class ReportInstallController : BasePluginController
    {
        ...
        private readonly string InstationPath = "Report.Web";
        public ReportInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
