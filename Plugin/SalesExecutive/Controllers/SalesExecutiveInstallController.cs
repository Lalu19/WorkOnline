...
namespace SalesExecutive.Controllers
{
	...
	public class SalesExecutiveInstallController : BasePluginController
	{
		...
		private readonly string InstationPath = "SalesExecutive";
		public SalesExecutiveInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
