                ...
                if (salesAdminTargetDTO != null)
                {
                    ...
                    if (objcheck == null)
                    {
                        SalesAdminTarget target = new SalesAdminTarget
                        {
                            ...
                            SectorId = (int?)Convert.ToInt64(salesAdminTargetDTO.Sector),
                            CategoryId = (int?)Convert.ToInt64(salesAdminTargetDTO.Category),
            ...
            try
            {
                ...
                if (targetWithSameName == null)
                {
                    ...
                    if (targetToUpdate != null)
                    {
                        ...
                        targetToUpdate.SectorId = (int?)Convert.ToInt64(salesAdminTargetDTO.Sector);
                        targetToUpdate.CategoryId = (int?)Convert.ToInt64(salesAdminTargetDTO.Category);
