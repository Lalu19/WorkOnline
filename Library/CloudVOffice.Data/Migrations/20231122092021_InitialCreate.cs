    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Applications", "Application", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2181), false, "icon-th-large-outline", "/appstatic/images/applications.png", true, null, null, null, "/Application/Applications/InstalledApps" },
                    { 2, null, "Setup", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2194), false, "icon-cogs", "/appstatic/images/setup.png", true, null, null, null, "/Setup/Setup/Dashboard" },
                    { 3, null, "Company Settings", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2198), false, "icon-office", null, true, 2, null, null, "" },
                    { 4, null, "Company", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2201), false, null, null, false, 3, null, null, "/Setup/CompanyDetails/CompanyDetailsView" },
                    { 5, null, "Letter Head", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2205), false, null, null, false, 3, null, null, "/Setup/LetterHead/LetterHeadView" },
                    { 6, null, "User", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2208), false, "icon-users", null, true, 2, null, null, "" },
                    { 7, null, "User List", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2212), false, null, null, false, 6, null, null, "/Setup/User/UserList" },
                    { 8, null, "Email Setup", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2215), false, "icon-envelop", null, true, 2, null, null, "" },
                    { 9, null, "Domain", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2219), false, null, null, true, 8, null, null, "/Setup/EmailDomain/EmailDomainView" },
                    { 10, null, "Email Account", "Setup", 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(2222), false, null, null, true, 8, null, null, "/Setup/EmailAccount/EmailAccountView" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 19, DateTimeKind.Local).AddTicks(9244), null, false, "admin@appman.in", null, "Administrator", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", null, "r9NmU79/NE0x0el2cuI8PeI4GlVCdpOeB875sWPUeJw=", "9583000000", null, null, null, null, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3338), false, 1, null, null },
                    { 2L, 2, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3345), false, 1, null, null },
                    { 3L, 3, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3348), false, 1, null, null },
                    { 4L, 4, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3351), false, 1, null, null },
                    { 5L, 5, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3429), false, 1, null, null },
                    { 6L, 6, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3433), false, 1, null, null },
                    { 7L, 7, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3436), false, 1, null, null },
                    { 8L, 8, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3438), false, 1, null, null },
                    { 9L, 9, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3440), false, 1, null, null },
                    { 10L, 10, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(3443), false, 1, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4411), false, null, null, 1L },
                    { 2L, 2, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4419), false, null, null, 1L },
                    { 3L, 3, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4422), false, null, null, 1L },
                    { 4L, 4, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4424), false, null, null, 1L },
                    { 5L, 5, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4427), false, null, null, 1L },
                    { 6L, 6, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4430), false, null, null, 1L },
                    { 7L, 7, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4432), false, null, null, 1L },
                    { 8L, 8, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4435), false, null, null, 1L },
                    { 9L, 9, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4438), false, null, null, 1L },
                    { 10L, 10, 1L, new DateTime(2023, 11, 22, 14, 50, 21, 20, DateTimeKind.Local).AddTicks(4440), false, null, null, 1L }
                });
