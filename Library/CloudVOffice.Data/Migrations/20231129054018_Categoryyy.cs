...
{
    /// <inheritdoc />
    public partial class Categoryyy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Applications", "Application", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(155), false, "icon-th-large-outline", "/appstatic/images/applications.png", true, null, null, null, "/Application/Applications/InstalledApps" },
                    { 2, null, "Setup", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(159), false, "icon-cogs", "/appstatic/images/setup.png", true, null, null, null, "/Setup/Setup/Dashboard" },
                    { 3, null, "Company Settings", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(161), false, "icon-office", null, true, 2, null, null, "" },
                    { 4, null, "Company", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(162), false, null, null, false, 3, null, null, "/Setup/CompanyDetails/CompanyDetailsView" },
                    { 5, null, "Letter Head", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(164), false, null, null, false, 3, null, null, "/Setup/LetterHead/LetterHeadView" },
                    { 6, null, "User", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(166), false, "icon-users", null, true, 2, null, null, "" },
                    { 7, null, "User List", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(167), false, null, null, false, 6, null, null, "/Setup/User/UserList" },
                    { 8, null, "Email Setup", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(169), false, "icon-envelop", null, true, 2, null, null, "" },
                    { 9, null, "Domain", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(170), false, null, null, true, 8, null, null, "/Setup/EmailDomain/EmailDomainView" },
                    { 10, null, "Email Account", "Setup", 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(172), false, null, null, true, 8, null, null, "/Setup/EmailAccount/EmailAccountView" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 430, DateTimeKind.Local).AddTicks(9841), null, false, "admin@appman.in", null, "Administrator", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", null, "r9NmU79/NE0x0el2cuI8PeI4GlVCdpOeB875sWPUeJw=", "9583000000", null, null, null, null, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(339), false, 1, null, null },
                    { 2L, 2, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(341), false, 1, null, null },
                    { 3L, 3, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(342), false, 1, null, null },
                    { 4L, 4, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(343), false, 1, null, null },
                    { 5L, 5, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(344), false, 1, null, null },
                    { 6L, 6, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(345), false, 1, null, null },
                    { 7L, 7, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(347), false, 1, null, null },
                    { 8L, 8, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(350), false, 1, null, null },
                    { 9L, 9, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(351), false, 1, null, null },
                    { 10L, 10, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(352), false, 1, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(525), false, null, null, 1L },
                    { 2L, 2, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(527), false, null, null, 1L },
                    { 3L, 3, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(529), false, null, null, 1L },
                    { 4L, 4, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(530), false, null, null, 1L },
                    { 5L, 5, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(532), false, null, null, 1L },
                    { 6L, 6, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(533), false, null, null, 1L },
                    { 7L, 7, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(534), false, null, null, 1L },
                    { 8L, 8, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(536), false, null, null, 1L },
                    { 9L, 9, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(537), false, null, null, 1L },
                    { 10L, 10, 1L, new DateTime(2023, 11, 29, 11, 10, 18, 431, DateTimeKind.Local).AddTicks(538), false, null, null, 1L }
                });
