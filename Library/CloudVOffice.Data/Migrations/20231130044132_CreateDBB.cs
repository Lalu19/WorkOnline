        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitOfMeasurement = table.Column<double>(type: "float", nullable: false),
                    CaseWeight = table.Column<int>(type: "int", nullable: true),
                    UnitPerCase = table.Column<int>(type: "int", nullable: true),
                    ManufactureDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Barcode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BarCodeAvailable = table.Column<bool>(type: "bit", nullable: false),
                    MRP = table.Column<int>(type: "int", nullable: false),
                    PurchaseCost = table.Column<int>(type: "int", nullable: false),
                    SalesCost = table.Column<int>(type: "int", nullable: false),
                    CGST = table.Column<double>(type: "float", nullable: true),
                    SGST = table.Column<double>(type: "float", nullable: true),
                    HandlingType = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Applications", "Application", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9705), false, "icon-th-large-outline", "/appstatic/images/applications.png", true, null, null, null, "/Application/Applications/InstalledApps" },
                    { 2, null, "Setup", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9709), false, "icon-cogs", "/appstatic/images/setup.png", true, null, null, null, "/Setup/Setup/Dashboard" },
                    { 3, null, "Company Settings", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9713), false, "icon-office", null, true, 2, null, null, "" },
                    { 4, null, "Company", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9716), false, null, null, false, 3, null, null, "/Setup/CompanyDetails/CompanyDetailsView" },
                    { 5, null, "Letter Head", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9718), false, null, null, false, 3, null, null, "/Setup/LetterHead/LetterHeadView" },
                    { 6, null, "User", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9721), false, "icon-users", null, true, 2, null, null, "" },
                    { 7, null, "User List", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9724), false, null, null, false, 6, null, null, "/Setup/User/UserList" },
                    { 8, null, "Email Setup", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9727), false, "icon-envelop", null, true, 2, null, null, "" },
                    { 9, null, "Domain", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9730), false, null, null, true, 8, null, null, "/Setup/EmailDomain/EmailDomainView" },
                    { 10, null, "Email Account", "Setup", 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(9733), false, null, null, true, 8, null, null, "/Setup/EmailAccount/EmailAccountView" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 418, DateTimeKind.Local).AddTicks(8811), null, false, "admin@appman.in", null, "Administrator", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", null, "r9NmU79/NE0x0el2cuI8PeI4GlVCdpOeB875sWPUeJw=", "9583000000", null, null, null, null, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(483), false, 1, null, null },
                    { 2L, 2, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(486), false, 1, null, null },
                    { 3L, 3, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(488), false, 1, null, null },
                    { 4L, 4, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(490), false, 1, null, null },
                    { 5L, 5, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(493), false, 1, null, null },
                    { 6L, 6, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(495), false, 1, null, null },
                    { 7L, 7, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(497), false, 1, null, null },
                    { 8L, 8, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(499), false, 1, null, null },
                    { 9L, 9, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(501), false, 1, null, null },
                    { 10L, 10, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(503), false, 1, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1106), false, null, null, 1L },
                    { 2L, 2, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1111), false, null, null, 1L },
                    { 3L, 3, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1113), false, null, null, 1L },
                    { 4L, 4, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1115), false, null, null, 1L },
                    { 5L, 5, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1117), false, null, null, 1L },
                    { 6L, 6, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1120), false, null, null, 1L },
                    { 7L, 7, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1122), false, null, null, 1L },
                    { 8L, 8, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1124), false, null, null, 1L },
                    { 9L, 9, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1127), false, null, null, 1L },
                    { 10L, 10, 1L, new DateTime(2023, 11, 30, 10, 11, 32, 419, DateTimeKind.Local).AddTicks(1129), false, null, null, 1L }
                });
