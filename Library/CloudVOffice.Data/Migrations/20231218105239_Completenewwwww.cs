...
{
    /// <inheritdoc />
    public partial class Completenewwwww : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Applications", "Application", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3618), false, "icon-th-large-outline", "/appstatic/images/applications.png", true, null, null, null, "/Application/Applications/InstalledApps" },
                    { 2, null, "Setup", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3621), false, "icon-cogs", "/appstatic/images/setup.png", true, null, null, null, "/Setup/Setup/Dashboard" },
                    { 3, null, "Company Settings", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3623), false, "icon-office", null, true, 2, null, null, "" },
                    { 4, null, "Company", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3625), false, null, null, false, 3, null, null, "/Setup/CompanyDetails/CompanyDetailsView" },
                    { 5, null, "Letter Head", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3626), false, null, null, false, 3, null, null, "/Setup/LetterHead/LetterHeadView" },
                    { 6, null, "User", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3628), false, "icon-users", null, true, 2, null, null, "" },
                    { 7, null, "User List", "Setup", 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3630), false, null, null, false, 6, null, null, "/Setup/User/UserList" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3058), null, false, "admin@appman.in", null, "Administrator", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", null, "r9NmU79/NE0x0el2cuI8PeI4GlVCdpOeB875sWPUeJw=", "9583000000", null, null, null, null, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3985), false, 1, null, null },
                    { 2L, 2, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3988), false, 1, null, null },
                    { 3L, 3, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3989), false, 1, null, null },
                    { 4L, 4, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3990), false, 1, null, null },
                    { 5L, 5, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3992), false, 1, null, null },
                    { 6L, 6, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3993), false, 1, null, null },
                    { 7L, 7, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3994), false, 1, null, null },
                    { 8L, 8, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3995), false, 1, null, null },
                    { 9L, 9, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3997), false, 1, null, null },
                    { 10L, 10, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(3998), false, 1, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4325), false, null, null, 1L },
                    { 2L, 2, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4328), false, null, null, 1L },
                    { 3L, 3, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4329), false, null, null, 1L },
                    { 4L, 4, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4331), false, null, null, 1L },
                    { 5L, 5, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4332), false, null, null, 1L },
                    { 6L, 6, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4333), false, null, null, 1L },
                    { 7L, 7, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4335), false, null, null, 1L },
                    { 8L, 8, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4336), false, null, null, 1L },
                    { 9L, 9, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4338), false, null, null, 1L },
                    { 10L, 10, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4348), false, null, null, 1L },
                    { 11L, 1, 1L, new DateTime(2023, 12, 18, 16, 22, 39, 370, DateTimeKind.Local).AddTicks(4349), false, null, null, 4L }
                });
